...
LocalStorageService.ɵfac = function LocalStorageService_Factory(t) { return new (t || LocalStorageService)(ɵngcc0.ɵɵinject(NGX_LOCAL_STORAGE_SERIALIZER), ɵngcc0.ɵɵinject(NGX_LOCAL_STORAGE_CONFIG)); };
...
StorageEventService.ɵfac = function StorageEventService_Factory(t) { return new (t || StorageEventService)(); };
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(StorageEventService, [{
        type: Injectable,
        args: [{ providedIn: 'root' }]
...
LocalStorageDirective.ɵfac = function LocalStorageDirective_Factory(t) { return new (t || LocalStorageDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(LocalStorageService), ɵngcc0.ɵɵdirectiveInject(StorageEventService)); };
LocalStorageDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: LocalStorageDirective, selectors: [["", "ngxLocalStorage", ""]], inputs: { lsDebounce: "lsDebounce", lsInitFromStorage: "lsInitFromStorage", lsValuePath: "lsValuePath", lsKey: ["ngxLocalStorage", "lsKey"], lsPrefix: "lsPrefix", lsEvent: "lsEvent", lsFalsyTransformer: "lsFalsyTransformer" }, outputs: { lsStoredValue: "lsStoredValue" } });
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(LocalStorageDirective, [{
        type: Directive,
        args: [{
                selector: '[ngxLocalStorage]'
            }]
    }], function () { return [{ type: ɵngcc0.ElementRef }, { type: LocalStorageService }, { type: StorageEventService }]; }, { lsDebounce: [{
            type: Input
        }], lsInitFromStorage: [{
            type: Input
        }], lsStoredValue: [{
...
DefaultSerializer.ɵfac = function DefaultSerializer_Factory(t) { return new (t || DefaultSerializer)(); };
DefaultSerializer.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: DefaultSerializer, factory: DefaultSerializer.ɵfac });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(DefaultSerializer, [{
        type: Injectable
    }], null, null); })();
...
NgxLocalStorageModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: NgxLocalStorageModule });
NgxLocalStorageModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function NgxLocalStorageModule_Factory(t) { return new (t || NgxLocalStorageModule)(ɵngcc0.ɵɵinject(NgxLocalStorageModule, 12)); }, providers: [
        {
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NgxLocalStorageModule, { declarations: [LocalStorageDirective], exports: [LocalStorageDirective] }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NgxLocalStorageModule, [{
        type: NgModule,
        args: [{
                imports: [],
                declarations: [
    ...
    }], function () { return [{ type: NgxLocalStorageModule, decorators: [{
                type: Optional
            }, {
                type: SkipSelf
            }] }]; }, null); })();
